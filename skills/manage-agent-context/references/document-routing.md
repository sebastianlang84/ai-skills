...
Use this to decide where durable repo/agent information belongs. Goal: one clear home per kind of information.
...
| Normative agent behavior, bootstrap/read order, hard constraints, stop conditions, repo-specific gates | `AGENTS.md`, `CLAUDE.md`, or equivalent | Project state, task history, long runbooks, verbose policy docs |
